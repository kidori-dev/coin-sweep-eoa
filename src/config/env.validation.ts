...
export const envValidationSchema = Joi.object({
  ...
  TRON_NETWORK: Joi.string().default('nile'),
  ...
  TRON_GAS_TOPUP_SUN: Joi.number().default(30000000),
  TRON_ACTIVATION_SUN: Joi.number().default(1000000),
  TRON_TRX_RESERVE_SUN: Joi.number().default(0),
  TRON_MIN_SWEEP_TRX_SUN: Joi.number().default(100000),
  TRON_MIN_SWEEP_TOKEN: Joi.number().default(1000000),
